            ...
            <div class="col-12 stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Edit Expense </p>
                        @if ($errors->any())
                        ...
                        <form class="forms-sample" action="{{route('dashboard.expences.store')}}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="number" class="form-control" id="exampleInputPassword2" placeholder="Price" name="price" value="{{$expense->price}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Description</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="description" id="exampleTextarea1" cols="30" rows="3">{{$expense->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Date</label>
                                <div class="col-sm-9">
                                <input type="date" class="form-control" id="exampleInputPassword2" placeholder="" name="date" value="{{$expense->date}}">
                                </div>
                            </div>
